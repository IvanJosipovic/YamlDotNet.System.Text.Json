...
internal static class BuilderConfigurationExample
{
    public static void Run()
    {
        ...
        var serializer = new StaticSerializerBuilder(context).AddSystemTextJson(sortAlphabetically: true).Build();
        ...
        SampleAssert.YamlEquals(builderYaml, """
            ...
            """, "Static builder configuration should produce the expected YAML document.");
